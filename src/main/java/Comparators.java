...
public static void main(String[] args){
    ...
    System.out.println(c.isEqual(1, 1));
    System.out.println(c.greaterThan(2, 1));
    System.out.println(c.lessThan(1, 2));
    System.out.println(c.greaterThanOrEqualTo(2, 1));
    System.out.println(c.lessThanOrEqualTo(1, 2));
    System.out.println(c.notEqualTo(1, 1));
}
}